    ...
    <div class="shadow-md rounded-lg">
        @if (session()->has('error'))
                <div class="flex flex-col m-3">
                    <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-red-800 dark:text-white"
                        role="alert">
                        ...
                        <span class="sr-only">Oh!</span>
                        <div>
                            <span class="font-medium">Oh!</span> {{ session('error') }}
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="flex justify-between px-3 py-4">
                <h2>Manage Record</h2>
                    <input type="text" class="border" wire:model="search" autofocus>
                </form>
            </div>
                ...
                @foreach ($records as $item)
                    <tr
                        ...
                        <td class="px-6 py-4 text-left flex">
                            ...
                            <button type="button"  data-modal-target="edit{{$item->id}}" data-modal-toggle="edit{{$item->id}}" wire:click="getId({{$item->id}})"
                                ...
                                <div wire:ignore.self id="edit{{$item->id}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                    <div class="relative w-full h-full max-w-md md:h-auto">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="px-6 py-6 lg:px-8">
                                                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">{{$item->name}} Edit's Record  </h3>
